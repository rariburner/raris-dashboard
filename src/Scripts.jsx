...
function ScriptEditor({ script, onClose, onSave, onDelete }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.88)" }} onClick={onClose} />
      {contextMenu && <AIContextMenu x={contextMenu.x} y={contextMenu.y} onAction={handleAIAction} onClose={() => setContextMenu(null)} />}
      <div style={{ position: "relative", background: "#141414", borderRadius: 20, width: 780, maxWidth: "96vw", maxHeight: "92vh", overflow: "hidden", display: "flex", flexDirection: "column", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 40px 100px rgba(0,0,0,0.9)" }}>
