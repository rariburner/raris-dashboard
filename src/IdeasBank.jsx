...
const sampleIdeas = [
  ...
  { id: 4, date: "2026-03-21", hook: "I have 350 million views. If I lost every follower, every post, and every dollar tomorrow — here's exactly what I'd do on day one.", format: "Format 5 — Storytelling", angle: "Fear + curiosity", cta: "Comment SYSTEM", why: "The restart scenario is evergreen viral. Mike's version is credible because he actually lost everything.", account: "jun_yuh", plays: 939128, url: "https://www.instagram.com/p/DQVX6PskWOP/", used: false },
  ...
  { id: 8, date: "2026-03-20", hook: "The creator economy doesn't have too many creators. It doesn't have enough. The ones who quit are the only reason you still have a chance.", format: "Format 4 — Declarative", angle: "Desire + identity trigger", cta: "Comment FREE", why: "Worldview reels build cult followings. People adopt the take as their own.", account: "getpaidtoexist", plays: 656418, url: "https://www.instagram.com/p/DM1LjonSAsp/", used: false },
